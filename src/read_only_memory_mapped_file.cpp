...
mk::read_only_memory_mapped_file_t::read_only_memory_mapped_file_t(nchar const* const file_path) :
...
std::size_t mk::read_only_memory_mapped_file_t::get_size() const
{
